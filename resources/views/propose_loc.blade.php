        ...
        <form method="post" action="insert" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-2">
                    ...
                    data-toggle="tooltip" data-placement="right" title="Le prix correspond à la location pour une durée d'une demi-journée" required>
                </div>
            </div>
            ...
            <div class="card my-4">
                ...
                <div id="collapseOne" class="collapse show my-2" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
            ...
            <div class="form-group">
                <input id="input-b3" name="photo[]" type="file" class="file" multiple data-show-upload="false"
                    ...
                    data-msg-placeholder="Ajouter des photos de votre bien ...">
            </div>
